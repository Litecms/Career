<div class="btn-group career-job">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[job_type]" class="col-sm-2 control-label">
                                        {!! trans('career::job.label.job_type')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[job_type]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[location]" class="col-sm-2 control-label">
                                        {!! trans('career::job.label.location')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[location]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[published]" class="col-sm-2 control-label">
                                        {!! trans('career::job.label.published')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".career-job .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/career.job.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".career-job .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.career-job .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'career.job.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#career-job-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#career-job-list .btn-reset-filter').css('display', 'none');
