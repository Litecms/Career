    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                ...
                @if($job['published'] == 'Yes')
                    <button type="button" class="btn btn-default btn-sm" data-action="REQUEST" data-load-to='#career-job-entry' data-href='{{ guard_url('career/publish') }}/{{$job->getRouteKey()}}/unpublish'><i class="fa fa-pencil-square"></i> Unpublish</button>
                    
                @else
                     <button type="button" class="btn btn-warning btn-sm" data-action="REQUEST" data-load-to='#career-job-entry' data-href='{{ guard_url('career/publish') }}/{{$job->getRouteKey()}}/publish'><i class="fa fa-pencil-square"></i> Publish</button>
        ...
        ->action(guard_url('career/job'))!!}
            <div class="tab-content clearfix disabled">
                <div class="tab-pan-title"> {{ trans('app.view') }}   {!! trans('career::job.name') !!}  [{!! $job->title !!}] @if($job['published'] == 'Yes') Published @endif</div>
