<div class="btn-group career-resume">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[job_id]" class="col-sm-2 control-label">
...
$(document).ready(function(){
    ...
    $(".career-resume .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/career.resume.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".career-resume .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.career-resume .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'career.resume.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#career-resume-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#career-resume-list .btn-reset-filter').css('display', 'none');
